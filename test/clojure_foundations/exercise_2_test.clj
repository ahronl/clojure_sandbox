...
(deftest attr-test
  (testing "attr")
    (is (= 110 ((attr :intelligence) my-character))))

(deftest new-comp-test
	(testing "new-comp")
	(is (= 90 ((new-comp :harms :strength :attributes) my-character))))
...
(deftest assoc-in-test
	...
	(is (= [{:name "James", :age 26} {:name "John", :age 44}] (new-assoc-in users [1 :age] 44)))
	(is (= [{:name "James", :age 26} {:name "John", :age 43} {:name "Jack", :age 19}] (new-assoc-in users [2] {:name "Jack" :age 19}))))
