(defproject clojure-foundations "0.1.0-SNAPSHOT"
  ...
  :profiles {:uberjar {:aot [clojure-foundations.core clojure-foundations.fwpd.core clojure-foundations.peg-thing-game.core clojure-foundations.concurrency.core]}})
